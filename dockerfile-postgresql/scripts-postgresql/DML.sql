...
insert into especialidad(id_especialidad,nombre) values (1,'CARDIOLOGÍA');

---------------------------
--USUARIOS DE EJEMPLO CON CLAVE 123
INSERT INTO usuario(id_usuario, nombre, clave, estado) values (1, 'mitocode', '$2a$10$1D8U/.sVT6szbY1GFKR6HOcPtDXUZl.GDr8Nkb8ip/CO0oqqJzEY6', '1');
INSERT INTO usuario(id_usuario, nombre, clave, estado) values (2, 'jaime', '$2a$10$1D8U/.sVT6szbY1GFKR6HOcPtDXUZl.GDr8Nkb8ip/CO0oqqJzEY6', '1');
update usuario set nombre='mito@gmail.com' where id_usuario=2;
